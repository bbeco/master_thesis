...
\todo[inline]{da qui in poi e' solo una bozza}
...
the sphere centered in the center of projection and with unitary radius.
...
An image point like $\myvec{m}$ can be defined by the spherical coordinate 
...
\begin{equation*}
	...
	\end{pmatrix}	\text{,}
\end{equation*}
\noindent where $\alpha$ is a scalar.
...
equirectangular 
images with \todo{aggiungere riferimento a formule} and then used the 
