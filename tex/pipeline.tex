...
\todo[inline]{Non voleva essere un vero e proprio flow chart ma solo una rappresentazione informale. Se preferite il flow chart corretto, lo correggo.}
\begin{figure}
	\centering
...
\missingfigure{Immagine per la densificazione come figura 3.2 di SfM. Se va bene
un equivalente di 3.2 lo faccio subito, altrimenti se e' meglio inserire un
vero e proprio flow chart, correggo il 3.2 e faccio anche questo.}.
